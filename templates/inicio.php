...
<div class="contenedor">
   ...
   <p class="titulo">Woodland le abre sus puertas</p>
    <div class="grid">
        <div class="col espe1"><?php echo do_shortcode('[video width="1920" height="1080" mp4="https://woodlandhouse.com.mx/wp-content/uploads/2020/10/WoodlandHoues_Master_HD.mp4.mp4"][/video]'); ?></div>
        <div class="col espe2">
